...
/**
 * Created by evolution on 6/23/2017.
 */
...
public class TinyDB {
    ...
    public ArrayList<BMIModel> getListObject(String key) {

        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<BMIModel> objects = new ArrayList<BMIModel>();
        for (String jObjString : objStrings) {
            BMIModel value = gson.fromJson(jObjString, BMIModel.class);
            objects.add(value);
        }
    ...
    public ArrayList<RecyclerposModel> getListObject1(String key) {

        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<RecyclerposModel> objects = new ArrayList<RecyclerposModel>();
        for (String jObjString : objStrings) {
            RecyclerposModel value = gson.fromJson(jObjString, RecyclerposModel.class);
            objects.add(value);
        }
        Log.e("TinyDB","fav list"+objects);
        return objects;
...
*/
    public void putListObject(String key, ArrayList<BMIModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (BMIModel obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
/*
    public void putListObject1(String key, ArrayList<RecyclerposModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (RecyclerposModel obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }

    public void putListObject2(String key, ArrayList<RecyclerPageposModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (RecyclerPageposModel obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }*/
