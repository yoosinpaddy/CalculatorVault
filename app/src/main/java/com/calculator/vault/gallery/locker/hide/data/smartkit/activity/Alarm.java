...
public class Alarm implements Comparable<Alarm> {
    ...
    private long mId;
    private String mTitle,notification_title;
    private long mDate;
    ...
    public void toIntent(Intent intent) {
        ...
        intent.putExtra("com.taradov.alarmme.notification_title", notification_title);
    ...
    public void fromIntent(Intent intent) {
        ...
        notification_title = intent.getStringExtra("com.taradov.alarmme.notification_title");
    ...
    public void deserialize(DataInputStream dis) throws IOException {
        mId = dis.readLong();
        mTitle = dis.readUTF();
        notification_title = dis.readUTF();
        mDate = dis.readLong();
