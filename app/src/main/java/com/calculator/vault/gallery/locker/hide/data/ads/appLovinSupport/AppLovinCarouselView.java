...
import static com.calculator.vault.gallery.locker.hide.data.ads.appLovinSupport.LayoutUtils.MATCH_PARENT;
import static com.calculator.vault.gallery.locker.hide.data.ads.appLovinSupport.LayoutUtils.WRAP_CONTENT;
        ...
        implements AppLovinActivityCallbacks
{
    ...
    private void renderSingleView()
    {
        ...
        singleCardView.setLayoutParams( LayoutUtils.createLinearParams( MATCH_PARENT, MATCH_PARENT, Gravity.CENTER, new LayoutUtils.DPMargins( getContext(), AppLovinCarouselViewSettings.VIEW_PAGER_MARGIN, 0, AppLovinCarouselViewSettings.VIEW_PAGER_MARGIN, 0 ) ) );
    ...
    private void renderViewPager()
    {
        ...
        carouselViewPager.setLayoutParams( LayoutUtils.createLinearParams( MATCH_PARENT, MATCH_PARENT, Gravity.CENTER ) );
        carouselViewPager.setBackgroundColor(getResources().getColor(AppLovinCarouselViewSettings.VIEW_PAGER_BACKGROUND_COLOR));
    ...
    private void renderActivityIndicator()
    {
        ...
        loadingIndicator.setBackgroundColor(getResources().getColor(AppLovinCarouselViewSettings.VIEW_PAGER_BACKGROUND_COLOR));
