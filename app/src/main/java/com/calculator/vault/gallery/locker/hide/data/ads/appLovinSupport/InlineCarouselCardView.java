        ...
        implements InlineCarouselCardCallbacks, AppLovinNativeAdPrecacheListener
{
    ...
    public void renderCard()
    {
        if ( !slotRendered )
        {
            ...
            appIconImageView.setOnClickListener(v -> ad.launchClickTarget( getContext() ));

            appDescriptionTextView.setText( ad.getDescriptionText() );

            final AppLovinTouchToClickListener clickBridge = new AppLovinTouchToClickListener( getContext(), v -> handleVideoClicked());
            ...
            downloadButton.setOnClickListener(v -> ad.launchClickTarget( getContext() ));

            contentLayout.setOnClickListener(v -> ad.launchClickTarget( getContext() ));
