...
public class CameraPreview extends ViewGroup {
    ...
    private RotationCallback rotationCallback = new RotationCallback() {
        ...
        public void onRotationChanged(int rotation) {
            // Make sure this is run on the s_activity_world_clock thread.
    ...
    /**
     * Call this on the s_activity_world_clock thread, while the preview is running.
     *
     ...
     *
     * This blocks the s_activity_world_clock thread.
     */
